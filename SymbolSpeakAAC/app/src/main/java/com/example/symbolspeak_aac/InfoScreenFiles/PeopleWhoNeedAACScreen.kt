...
fun PeopleWhoNeedAACScreen() {
    ...
    Column(
        ...
        Text(text = stringResource(id = R.string.peopleWhoNeedAAC), fontSize = fontSize.value.sp)
        Text(text = stringResource(id = R.string.definePeopleWhoNeedAAC), fontSize = fontSize.value.sp)
    }
}